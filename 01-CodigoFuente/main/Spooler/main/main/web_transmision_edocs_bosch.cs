    ...
    internal class web_transmision_edocs_bosch
    {
        public string transmision_edocs_bosch(string Carpeta, string Archivo, string Clientes, string Fecha_1, string Fecha_2, string imp_exp, string tipo_doc)
        {
            ...
            if (imp_exp.Trim() == "1" || imp_exp.Trim() == "2")
            {
                ...
                xlsx.CrearExcel_file(LisDT, LisDT_tit);
                xlsx.CreadorExcel_2F(LisDT, LisDT_tit);
            }
            else
            {
                ...
                LisDT[0] = DM.datos(DM.transmision_edocs_bosch(Clientes, Fecha_1, Fecha_2, "", tipo_doc, "2"));
                LisDT_tit[0] = "Exportación";
                Console.WriteLine(util.Tdetalle(LisDT[0]));
                Console.WriteLine("/********tipo 1***/////////");
                LisDT[1] = DM.datos(DM.transmision_edocs_bosch(Clientes, Fecha_1, Fecha_2, "", tipo_doc, "1"));
