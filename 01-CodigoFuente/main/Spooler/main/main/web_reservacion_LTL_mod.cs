...
namespace serverreports
{
    ...
    {
        public (string[,] LisDT_tit, DataTable[] LisDT, string arch) reservacion_ltl
        ...
        public (string[,] LisDT_tit, DataTable[] LisDT, string arch) reservacion_ltl_ant
                  (string Carpeta, string[,] file_name, string Cliente, string cantidad, string[,] pargral, int visible_sql, string? id_cron = "")
        {
            string IP_ADDRESS;
            ...
            string[,] par_st = new string[7, 4];
            List<string>? campos = new List<string>();
            if (id_cron.ToString() != "" && (pargral[15, 1] == "1" || pargral[16, 1] == "1"))
            {
                IP_ADDRESS = null;
            if (pargral[14, 1] != "")
            {
